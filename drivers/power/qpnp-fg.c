...
#if (defined FACTORY_VERSION_ENABLE) || (defined CONFIG_PROJECT_VINCE)
...
#define DESAY_ID_MAX 27600
#define DESAY_ID_MIN 22000
#define COSLIGHT_ID_MAX 53600
#define COSLIGHT_ID_MIN 48000
#define SUNWODA_ID_MAX 43600
#define SUNWODA_ID_MIN 38000
#endif
static int fg_batt_profile_init(struct fg_chip *chip)
{
	...
	/*DESAY_ID：22000-27600*/
	/*COSLIGHT_ID：48000-53600*/
	/*SUNWODA_ID：38000-43600*/
	if (batt_id >= DESAY_ID_MIN && batt_id <= DESAY_ID_MAX) {
		match = 1;
		printk("SCUD match succ.\n");
	} else if (batt_id >= COSLIGHT_ID_MIN && batt_id <= COSLIGHT_ID_MAX) {
		match = 1;
