 ...
 * @resume_in_workqueue: do not disable/enable regulators in suspend/resume //feature vince
 ...
 * @bus_lpm_cur_uA: low power mode current setting for bus //feature vince
...
struct synaptics_dsx_board_data {
	...
	//bool wakeup_gesture_en; //feature vince
	//bool dont_disable_regs; //feature vince
	int irq_gpio;
	int irq_on_state;
	int power_gpio;
	int power_on_state;
	int reset_gpio;
	int reset_on_state;
	//int bus_lpm_cur_uA; //feature vince
	int max_y_for_2d;
	...
	//const char *fw_name; //feature vince
};
